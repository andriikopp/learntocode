...
<body style="margin: 1%;">
    <div class="jumbotron">
        <h1 class="display-4">Coding Tasks for Beginners</h1>
        ...
        <hr class="my-4">
        <p>There is a long journey before your first coding interview, but here you can start mastering your programming skills</p>
